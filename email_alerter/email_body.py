...
def get_email_body(item_type: str, item_name: str, item_url: str) -> str:
    """
    Replace values in the Email Body HTML constant
    """

    body = BODY
    body = body.replace("[[ITEM_NAME]]", item_name)
    body = body.replace("[[ITEM_TYPE]]", item_type)
    body = body.replace("[[ITEM_URL]]", item_url)
